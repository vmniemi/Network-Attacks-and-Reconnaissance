...
- Työkalun avulla tallennettu lähete voidaan purettuna tarkastella bittitasolle asti, ja kaapattu data voidaan muuntaa esimerkiksi heksadesimaali- tai ASCII-esitysmuotoon.

- Ohjelmalla voidaan kerätä talteen radioliikennettä halutulta taajuusalueelta myöhempää tutkimista varten.

  
  Cornelius 2022: Decode 433.92 MHz weather station data
  
- Universal Radio Hacker mahdollistaa radioviestien tallentamisen, analysoinnin, muokkaamisen sekä riittävällä laitteistolla signaaleita voidaan lähettää takasin ulos ilmaan.
- 
- rtl_433:n avulla voidaan kääntää noin 433 MHz taajuudella toimivien laitteiden lähettämät radiosignaalit ihmis kieleksi jota on helpompi ymmärtää .
  
- Signaalia kannattaa tallettaa vähän varsinaisen kohteen taajuuden ulkopuolelta, noin 20–100 kHz, jotta ohjelma pystyy laskea todellisen ja ilmoitetun taajuuden välisen erotuksen.
...
Menin sivulle http://websdr.ewi.utwente.nl:8901/, jota oltiin selattu yhdessä aikaisemmalla tunnilla.

Sieltä löysin G BBC radio 4, se olikin jo merkattu sinne ja tiedän varmasti että se on julkinen lähetys (Se on Iso-Britannian BBC radio 4)

taajuus: toimii kuuluvasti taajuuksilla 194.00  - 202.00 kHz (Selkein omaan korvaan 200.00 kHz)

aallonpituus:(200 kHz) ![Tämän nettisivun laskimen mukaa](https://www.everythingrf.com/rf-calculators/frequency-to-wavelength) 1498.96229 ≈ 1500 metriä
