...
omat liitännät voi tarkistaa komennoilla
  ...
  Menin sivulle tryhackme.com 
   ...
   Yritin lisätä tähän loppun .pcap tiedoston omasta sieppauksesta, mutten en millään osannut. Osaan kyllä siepata ja tallentaa .pcap tiedostoja, en vain osaa lisätä niitä .md tiedostoon githubilla
...
Kävin katsomassa tuon oudon gc.zgo.at/
 ...
 Eli todennäköisemmin tässä käytiin terokarvinen.com:ssa joka lähetti tiedon eteenpäin goatcounterille joka mm. pitää kirjaa kuinka monta kävijää sivulla on samaan aikaan (kts. https://terokarvinen.goatcounter.com/help/visitor-counter), mutta se on vaikea sanoa ratkaisevasti, koska TLS-salaus.
