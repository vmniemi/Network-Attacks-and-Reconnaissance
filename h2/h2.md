...
Syntaksi sille on frame contains "sana" eli tässä frame contains "nmap" (Lähde https://www.wireshark.org/docs/man-pages/wireshark-filter.html)
...
Porttiskannasin uudestaan 
  ...
  Siellä oli Nmapin ala kohdassa --script-args http.useragent="BSD experimental on XBox350 alpha (emulated on Nokia 3110)"
 ...
 Ajoin
  ...
  Nyt siellä oli vain yksi maininta Nmapista
